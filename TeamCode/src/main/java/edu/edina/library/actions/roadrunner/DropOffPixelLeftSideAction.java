...
public class DropOffPixelLeftSideAction implements Action {
    ...
    public DropOffPixelLeftSideAction(Claw claw, Lift lift, RobotHanger robotHanger, boolean isBackstage) {
        this.claw = claw;
        this.lift = lift;
