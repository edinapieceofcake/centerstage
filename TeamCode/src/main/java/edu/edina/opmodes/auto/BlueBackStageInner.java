...
public class BlueBackStageInner extends BackStage {
    ...
    protected void dropPurplePixel() {
        ...
        switch(propLocation) {
            case Left:
                ...
                propDropAngle = -65;
                backdropLocation = new Pose2d(42,39.5, Math.toRadians(0));
                break;
            case Right:
                propDropLocation = new Vector2d(7.5, 42);
                propDropAngle = 225;
                backdropLocation = new Pose2d(42,28.5, Math.toRadians(0));
                break;
            case Center:
            default:
