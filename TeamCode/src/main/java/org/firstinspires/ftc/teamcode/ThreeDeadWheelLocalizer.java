...
public final class ThreeDeadWheelLocalizer implements Localizer {
    public static class Params {
        public double par0YTicks = -773.49851343117344; // y position of the first parallel encoder (in tick units)
        public double par1YTicks = 709.4258038195981; // y position of the second parallel encoder (in tick units)
